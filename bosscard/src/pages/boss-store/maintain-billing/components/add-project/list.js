...
import { InputNumber, Modal, message, Icon, Button, Popover, Tooltip } from 'antd'
            ...
            return (
              <div className={styles.item} key={i}>
                <div className={styles.head + ' flex center'}>
                  ...
                  {
                    showCrad &&
                    <span className={styles.youhui} style={{color: '#FF6F28'}}>
                ...
                <div className={styles.content}>
                  <div className={styles.row + ' flex'}>
                    ...
                    <div className= {styles.operate + ' item'}>
                      <span onClick={() => this.subtract(v)} className={(v.num === 1 ? styles.disabled : ' ' )+ ' iconfont icon-jian'} ></span>
                      <InputNumber
                        min={1}
                        value={v.num}
                        precision={0}
                      ...
                      <span onClick={() => this.add(v)} className='iconfont icon-jia'></span>
                    </div>
                  </div>
                  {/* 选择销售 */}
                  {
