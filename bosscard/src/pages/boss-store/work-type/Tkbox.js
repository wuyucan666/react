  ...
  class extends Component {
    handleSubmit() {
      ...
      validateFields((err, values) => {
        ...
        if (type === "add") {
          services
            .insert({ data: values, keys: { name: "store/stafflevel" } })
            .then(res => {
              if (res.success) {
                hideModal()
                resetFields()
          ...
          services
            .update({ data: values, keys: { name: "store/stafflevel" } })
            .then(res => {
              if (res.success) {
                hideModal()
                resetFields()
        ...
        <div>
          ...
          >
            <Form className="from-wrap-margin">
              ...
              <FormItem {...formItemLayout} label="备注" className="from-wrap-remark">
                {getFieldDecorator(
                  "remark",
