...
class VisitOverdue extends Component {
  constructor(props){
    super(props)
    this.state={
      record:false,
  ...
  render() {
    ...
    tableConfig.screen.query={state:4}
    ...
    return (
      <div>
        {/* <div className={styles.zl_tableBox}><CommonMenu index={1}></CommonMenu></div> */}
        <CommonTable
...
export default connect(mapStateToProps)(VisitOverdue)
