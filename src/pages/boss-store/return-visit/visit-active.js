...
class VisitActive extends Component {
  constructor(props){
    super(props)
    this.state={
      record:false,
  ...
  render() {
    ...
    tableConfig.screen.query={state:2}
    ...
    return (
      <div>
        {/* <div className={styles.zl_tableBox}><CommonMenu index={2}></CommonMenu> </div> */}
        <CommonTable
...
export default connect(mapStateToProps)(VisitActive)
