    ...
    render(){
        ...
        return <div className={ style.zl_mast } >
          <div className={ style.zl_mast_content } >
           <p className={ style.zl_headerP } >功能介绍 <Icon onClick={ this.handerMastHidden }  type="close" style={{ float:'right' ,color:'#999' ,marginTop:'19px'  }}  /></p>
            <div className={ style.zl_mast_sectionone } >
             <img src={Scheduling_icon} alt=''  />
