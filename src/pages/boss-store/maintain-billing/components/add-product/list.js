...
import { InputNumber, Modal, message, Icon, Button, Tooltip, Popover } from 'antd'
            ...
            return(
              <div className={styles.item  + (v.checked ? ` ${ styles.checkedItem }` : ' ')} key={i}>
                <div className={styles.head + ' flex center'}>
                  ...
                  {
                    !v.pick && <span onClick={() => deleteHandel(v)}><Icon type="close" /></span>
                  }
                  </span>
                </div>
                              ...
                              <div>
                                {
                                  !v.pick ?
                                    <div className={styles.message}>
                                      <div>未领料</div>
                                      <Button size="large" type="primary" onClick={() => this.props.singel(v)}>领料</Button>
                                    </div>
                                    :
                                    <div className={styles.message}>
                                      <div>已领料</div>
                                      <Button size="large" onClick={() => this.props.singel(v)}>退料</Button>
                                    </div>
                                }
                              </div>
                          }
