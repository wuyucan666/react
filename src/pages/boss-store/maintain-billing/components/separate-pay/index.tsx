...
class separatePay extends Component<pageProps> {
  ...
  async cardPay(payment: any) {
    ...
    payList.map((v: any) => {
      if(v.clientCardId === payment.clientCardId) {
        ...
        if(v.canUse >= amount) {
          ...
          dispatch({type: 'maintainBilling/setGoodsItem', payload:{ commodity }})
        }else {
    ...
    await dispatch({type: 'maintainBilling/setGoodsItem', payload:{ commodity }})
                          ...
                          (
                            ...
                            onClick={async (e: any) => {
                              ...
                              await this.props.dispatch({
                                type: 'maintainBilling/setGoodsItem', 
                                payload:{ commodity },
                              })
                              this.countPendingPay()
                            }}
